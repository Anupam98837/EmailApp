  ...
  <div class="layout">
    <aside class="dashboard-sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav flex-grow-1">
        ...
        <a href="/admin/users/manage" class="nav-link">
          <i class="fa-solid fa-users"></i>
          <span>Users</span>
        </a>
        
        <a href="/admin/mailer/manage" class="nav-link">
          <i class="fa-solid fa-envelope"></i>
          <span>Mailer</span>
        </a>
        
        <a href="/admin/subscription/manage" class="nav-link">
          <i class="fa-solid fa-clipboard-list"></i>
          <span>Plan</span>
        </a>

        <a href="/admin/theme/manage" class="nav-link">
          <i class="fa-solid fa-palette"></i>
          <span>Theme</span>
        </a>

        <a href="/admin/payment-gateway/manage" class="nav-link">
          <i class="fa-solid fa-palette"></i>
